...
fun requirementBadges(missing: Set<String>): List<String> {
    ...
    val known = setOf(
        ...
        CapabilityIds.TRIGGER_NOTIFICATION, CapabilityIds.ACTION_CLEAR_NOTIFICATIONS,
        CapabilityIds.TRIGGER_APP_OPENED, CapabilityIds.STATE_FOREGROUND_APP,
        CapabilityIds.TRIGGER_PHONE_SMS, CapabilityIds.TRIGGER_PHONE_CALL, CapabilityIds.ACTION_SEND_SMS,
        CapabilityIds.TRIGGER_GEOFENCE, CapabilityIds.STATE_LOCATION,
