...
private val NothingDark = darkColorScheme(
    ...
    surface = Color(0xFF161616),       // card surfaces
    onSurface = Color(0xFFE8E8E8),     // text-primary on surface
    surfaceVariant = Color(0xFF1C1C1C),// elevated / raised surfaces
    onSurfaceVariant = Color(0xFF8A8A8A), // text-secondary
    outline = Color(0xFF2A2A2A),       // visible borders
    outlineVariant = Color(0xFF202020),// subtle separators
