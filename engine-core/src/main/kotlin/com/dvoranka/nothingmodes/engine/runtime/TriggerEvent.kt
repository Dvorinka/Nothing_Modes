...
sealed interface TriggerEvent {
    ...
    data class Registered(
        ...
        val automationId: com.dvoranka.nothingmodes.engine.model.AutomationId,
    ...
    data class PhoneStateChanged(
        override val eventId: String,
        val event: com.dvoranka.nothingmodes.engine.model.PhoneEvent,
        val number: String?,
        val smsText: String?,
    ) : TriggerEvent
    ...
    data class ConnectivityChanged(
        override val eventId: String,
        val medium: com.dvoranka.nothingmodes.engine.model.ConnMedium,
        val state: com.dvoranka.nothingmodes.engine.model.ConnState,
        val match: String?,
    ) : TriggerEvent
    ...
    data class ScreenStateChanged(
        override val eventId: String,
        val state: com.dvoranka.nothingmodes.engine.model.ScreenState,
    ) : TriggerEvent
