...
object GlyphChannels {
    ...
    fun forDevice(modelId: String): DeviceChannels? =
        when (modelId) {
            NothingDeviceIds.PHONE_1 ->
                DeviceChannels(
                    all = Phone1.ALL,
                    progress = Phone1.PROGRESS,
                    zones =
                        mapOf(
                            "A" to Phone1.ZONE_A,
                            "B" to Phone1.ZONE_B,
